    ...
    <>
      <div className="container mx-auto px-8">
        <div className="text-black mt-10">
          <div className="text-center mb-5 pb-3 border-b-2 border-red-800">
            <h3 className="text-2xl font-bold pb-1">Berita Populer</h3>
            <form onChange={handlefilter}>
                            <select
                                className="filter border-2 border-red-800 rounded-md hover:border-red-800 text-black  hover:text-red-800"
                                name="isAvailable"
                                value={keyword}
          ...
          <form>
            ...
            <div className="relative">
              ...
              <input
                type="search"
                id="default-search"
                className="block w-full px-4 py-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-black focus:border-red-800 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-black dark:focus:border-red-800"
                  ...
                  return (
                    <article className="overflow-hidden rounded-lg border border-gray-100 shadow-sm">
                      ...
                      <div className="p-4 sm:p-6">
                        <p className="bg-red-800 text-white px-0.5 rounded-md w-24 text-center">
                          {val.category}
                        </p>
                        <a href="#">
                ...
                .map((val) => {
                  ...
                  return (
                    <article className="overflow-hidden rounded-lg border border-gray-100 shadow-sm">
                      ...
                      <div className="p-4 sm:p-6">
                        <p className="bg-black text-white px-0.5 rounded-md w-16 text-center">
                          {val.category}
                        </p>
                        <a href="#">
                          <h3 className="text-lg font-medium text-gray-900">
