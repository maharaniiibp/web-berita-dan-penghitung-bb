...
function Adds() {
  return (
	...
	<div className="container flex flex-col mx-auto lg:flex-row my-28 ">
		<div className=" w-full lg:w-1/3 lg:ml-32" style={{backgroundImage:" url('https://assets.goal.com/v3/assets/bltcc7a7ffd2fbf71f5/blta9d7bcdd0fb454e0/640440e0e785912a31cd315e/arsenal_nelson.jpg?quality=60&format=pjpg&auto=webp&width=1000')", backgroundPosition: "center center;", backgroundSize: "cover;"}}></div>
		<div className="flex flex-col w-32 p-6 lg:w-2/3 md:p-8 lg:p-12">
